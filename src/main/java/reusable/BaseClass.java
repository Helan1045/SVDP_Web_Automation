...
public class BaseClass {
	...
	public int RowIndexTestscript(String testname) throws InterruptedException, IOException, AWTException {
		int RI = 0;
		try {
	...
	public void startReport() {
		...
		try {
			ExtentSparkReporter spark = new ExtentSparkReporter("C:\\Users\\helanmagdalin.t\\eclipse-workspace\\AOC_Project\\reports\\"+"Spark" + "_" + timeStamp + ".html");
